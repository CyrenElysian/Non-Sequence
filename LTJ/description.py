...
# ===== 配置 =====
INPUT_FILE = "filter/data/filter_loop_quality_dev.json"
OUTPUT_FILE = "filter/data/descriptions_dev.json"
BACKUP_FILE = "checkpoint/description_backup.json"  # 生成阶段备份
...
# 加载生成模板
templates = {
    "cont1": load_prompt("prompt/prompt_continue_1.txt"),
    "cont2": load_prompt("prompt/prompt_continue_2.txt"),
    "cont3": load_prompt("prompt/prompt_continue_3.txt"),
    "stop1": load_prompt("prompt/prompt_stop_1.txt"),
    "stop2": load_prompt("prompt/prompt_stop_2.txt"),
    "stop3": load_prompt("prompt/prompt_stop_3.txt"),
    "na":    load_prompt("prompt/prompt_na.txt"),
}
...
print(f"最终数据已保存至 {OUTPUT_FILE}，共 {len(results)} 条。")