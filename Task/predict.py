...
CHECKPOINT_FILE = "checkpoint/eval_checkpoint_v4-flash.json"
OUTPUT_FILE = "result/results_v4-flash.json"
SUMMARY_FILE = "summary/eval_summary_v4-flash.json"
...
if __name__ == "__main__":
    template = load_prompt_template("prompt/prompt_predict.txt")

    with open("../Construct/stats/CtrlScript_with_stats.json", "r", encoding="utf-8") as f:
        dataset = json.load(f)
